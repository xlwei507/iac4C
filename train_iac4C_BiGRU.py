...
df_train = pd.read_csv('./dataset/mix2-trian.csv')
df_test = pd.read_csv('./dataset/mix2-test.csv')
...
class MyNet(nn.Module):
    ...
    #-------------------------------------------------------------------------------
        # Pass the LSTM output tensor through the multi-head attention layer q k v
